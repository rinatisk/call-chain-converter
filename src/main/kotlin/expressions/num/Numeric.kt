...
class ConstantExpression(val number: String) : Numeric {
    override fun toString(): String = number

    override val toPolynomialImplementation = PolynomialImplementation(mutableListOf(number.toInt()))
}

class Plus(override val leftPart: Numeric, override val rightPart: Numeric, override val type: String = "+") : NumberBinaryExpression(leftPart, rightPart, "+"), Numeric {
...
class Minus(override val leftPart: Numeric, override val rightPart: Numeric) : NumberBinaryExpression(leftPart, rightPart, "-"), Numeric {
...
class Times(override val leftPart: Numeric, override val rightPart: Numeric) : NumberBinaryExpression(leftPart, rightPart, "*"), Numeric {
    override fun toString():String = NumberBinaryExpression(leftPart, rightPart, "*").toString()
